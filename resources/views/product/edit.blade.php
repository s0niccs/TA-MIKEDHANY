					...
					<div class="content-wrapperr">
						<div class="col-md-4 col-sm-6 col-12">
							<div class="card gradient-dark-grey">
								...
								<form action="/products/{{ $product->id }}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
									@csrf
									@method('PUT')
									<div class="card-body">
										<div class="mb-3 control-dark">
											<label class="form-label">Nama barang<span class="required">*</span></label>
											<input type="text" name="nama_barang" id="first-name" value="{{ old('nama_barang', $product->nama_barang) }}" class="form-control @error('nama_barang') is-invalid @enderror" placeholder="Masukkan nama barang" />
											@error('nama_barang')
										...
										<div class="mb-3 control-dark">
											...
											<textarea class="form-control" rows="2" type="text" id="first-name" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Masukkan deskripsi barang">{{ old('deskripsi', $product->deskripsi) }}</textarea>
											@error('deskripsi')
												<div class="invalid-feedback">
													{{ $message }}
												</div>
										...
										<div class="mb-3 control-dark">
											...
											<div class="input-group mb-3 control-dark">
												...
												<input type="number" class="form-control" step="any" id="first-name" name="harga" value="{{ old('harga', $product->harga) }}" placeholder="Masukkan harga barang" class="form-control @error('harga') is-invalid @enderror" />
												@error('harga')
													<div class="invalid-feedback">
														{{ $message }}
													</div>
										...
										<div class="mb-3 control-dark">
											...
											<input type="number" id="first-name" name="stok" value="{{ old('stok', $product->stok) }}" placeholder="Masukkan jumlah stok" class="form-control @error('stok') is-invalid @enderror" />
											@error('stok')
												<div class="invalid-feedback">
													{{ $message }}
												</div>
										...
										<div class="mb-3 control-dark">
											...
											<img src="{{ asset('uploads/products/' . $product->foto) }}" height="80px" width="80px" alt="">
										</div>
										<div class="ln_solid"></div>
										<div class="item form-group mt-4">
											<div class="d-flex col-md-6 col-sm-6">
												<button class="btn btn-danger border-0">
													<a href="/products" style="color:white !important;">Cancel</a>
												</button>
												<button type="submit" class="btn btn-primary border-0 px-2">Simpan</button>
											</div>
										</div>
									</div>
								</form>
